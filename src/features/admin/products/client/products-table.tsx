...
function SortButton({
  ...
  return (
    <button
      onClick={onClick}
      className="flex items-center h-8 gap-1.5 font-medium text-ink hover:text-neutral cursor-pointer"
    >
...
export function createProductColumns(
  ...
  return [
    ...
    },
    {
      ...
      enableSorting: false,
      cell: ({ row }) => (
        <div className="bg-muted/40 relative size-12 overflow-hidden rounded-sm">
          <Image
    ...
    },
    {
      ...
      header: "SKU",
      cell: ({ row }) => (
        <span className="text-neutral text-sm truncate">{row.original.sku}</span>
      ),
    },
    {
      id: "categories",
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const sellingPrice = formatPrice(row.original.sellingPrice, currency);
        return (
      ...
      cell: ({ row }) => (
        <div className="flex justify-end -ml-8">
          <Button asChild size="sm" variant="link">
            <Link href={`/${shopSlug}/products/${row.original.id}`}>
...
export function ProductsTable({
  ...
  const columns = React.useMemo(
    () => createProductColumns(currency, shopSlug),
    [currency, shopSlug],
  );
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center gap-2 py-4 text-center">
                    ...
                    <p className="text-neutral text-base mt-2">
        ...
        {rows.map((row) => {
          ...
          return (
            ...
            >
              ...
              <div className="bg-muted/40 relative size-11 shrink-0 overflow-hidden rounded-sm">
                <Image
              ...
              <Link href={`/${shopSlug}/products/${p.id}`} className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-ink hover:underline">
                  {p.name}
                </p>
                <div className="flex items-center gap-0.5 text-xs text-neutral">
              ...
              <div className="shrink-0 text-right">
                <p className="text-sm font-medium text-ink">
                  {formatPrice(p.sellingPrice, currency)}
                </p>
                <p
                  className={cn(
