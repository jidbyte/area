...
const ShopFooter = () => {
  ...
  const linkSections = [
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+1-212-456-7890", path: "/", icon: LuPhone },
        { text: "contact@example.com", path: "/", icon: LuMail },
        { text: "794 Francisco, 94102", path: "/", icon: LuMapPin },
      ],
    },
  ];
      ...
      <div className="mx-auto p-4 md:px-10">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mt-4 md:mt-8">
          <div>
            ...
            <p className="max-w-100 mt-6 text-sm">
              Welcome to area, your ultimate destination for the latest and
