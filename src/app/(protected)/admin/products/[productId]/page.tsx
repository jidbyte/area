...
import { ProductImageGallery } from "@/features/inventory/client/image-gallery";
import {
  PageAction,
  PageHeader,
  PageTitle,
...
import {
  AdjustStockDialog,
  DeleteProductDialog,
} from "@/features/inventory/client/product-actions";
              ...
              <div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <Tag className="text-ink/60 size-4" />
                    <span className="text-ink/60">Brand:</span>
                    <span className="text-ink">{product.brand || "—"}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Layers className="text-ink/60 size-4" />
                    <span className="text-ink/60">Model:</span>
                    <span className="text-ink">{product.model || "—"}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Barcode className="text-ink/60 size-4" />
              ...
              {categories.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-1.5">
                  {categories.map((c) => (
                    <span
                      key={c}
                      className="bg-muted text-ink rounded-full px-2.5 py-0.5 text-xs"
                    >
                      {c}
                    </span>
                  ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 h-fit">
            ...
            <div className="col-span-2 border p-4 md:p-6 rounded-md w-full">
              ...
              <div className="space-y-4">
                <div className="bg-muted/40 text-ink/80 flex justify-between rounded-md p-2.5 md:px-4">
            ...
            <div className="col-span-3 border p-4 md:p-6 rounded-md w-full">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div className="text-center space-y-2.5">
                  ...
                  <p className="text-ink/80 font-medium">Cost Price</p>
                ...
                <div className="text-center space-y-2.5">
                  ...
                  <p className="text-ink/80 font-medium">Selling Price</p>
                ...
                <div className="text-center space-y-2.5">
                  ...
                  <p className="text-ink/80 font-medium">Profit Margin</p>
                  <p
                    className={cn(
                      "text-2xl font-bold",
