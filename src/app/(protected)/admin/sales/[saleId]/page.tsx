...
import { SalePaymentActions } from "@/features/sales/client/sale-payment-actions";
import type { PaymentStatus } from "@/features/sales/server/schema";
      ...
      <div className="flex items-center justify-between">
        ...
        {saleRecord.paymentStatus !== "cancelled" && (
          <Button asChild size="sm" variant="outline">
            <Link href={`/admin/sales/${saleRecord.id}/edit`}>Edit</Link>
          </Button>
        )}
      </div>
