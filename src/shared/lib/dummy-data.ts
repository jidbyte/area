...
export const dummyShops = [
  {
    ...
    owner: { name: "GreatStack", email: "user.greatstack@gmail.com", image: demoImages.gs_logo },
  },
  {
    id: "shop_2",
    ...
    currency: "USD",
    isActive: true,
    logo: demoImages.happy_store,
    email: "happyshop@example.com",
    contact: "+0 1234567890",
    commissionRate: 500,
    createdAt: "2025-09-04T09:04:16.189Z",
    updatedAt: "2025-09-04T09:04:44.273Z",
    owner: { name: "Great Stack", email: "user.greatstack@gmail.com", image: demoImages.gs_logo },
  },
];
...
const productSeeds: ProductSeed[] = [
  ["Modern table lamp", 29, 40, demoImages.product_img1, "Decoration"],
  ["Smart speaker gray", 29, 50, demoImages.product_img2, "Speakers"],
  ["Smart watch white", 29, 60, demoImages.product_img3, "Watch"],
  ["Wireless headphones", 29, 70, demoImages.product_img4, "Headphones"],
  ["Smart watch black", 29, 49, demoImages.product_img5, "Watch"],
  ["Security camera", 29, 59, demoImages.product_img6, "Camera"],
  ["Smart pen for iPad", 29, 89, demoImages.product_img7, "Pen"],
  ["Home theater", 29, 99, demoImages.product_img8, "Theater"],
  ["Wireless earbuds", 29, 89, demoImages.product_img9, "Earbuds"],
  ["Smart watch pro", 29, 179, demoImages.product_img10, "Watch"],
  ["RGB gaming mouse", 29, 39, demoImages.product_img11, "Mouse"],
  ["Smart home cleaner", 29, 199, demoImages.product_img12, "Cleaner"],
];
...
export const dummyRatings = [
  {
    ...
    user: { name: "Kristin Watson", image: demoImages.profile_pic1 },
    productId: "prod_1",
  ...
  },
  {
    ...
    user: { name: "Jenny Wilson", image: demoImages.profile_pic2 },
    productId: "prod_2",
    createdAt: "2025-07-19T09:21:25.000Z",
  },
  {
    ...
    user: { name: "Bessie Cooper", image: demoImages.profile_pic3 },
    productId: "prod_3",
    createdAt: "2025-07-19T09:21:25.000Z",
  },
];
